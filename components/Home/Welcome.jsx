		...
		<Center flex={1} px="3">
			<Center>
              ...
              Welcome to the cornerstone app
						...
						<Text color="white">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Elementum consectetur amet tellus lobortis diam sed.
						</Text>
						<Button size="lg" onPress={() => navigation.navigate({name: screens.NEW_ORDER})}>
              New Order
						</Button>
						<Link onPress={() => navigation.setParams({ isFirstTime: false })}><Text color="white">Maybe later</Text></Link>
					</Stack>
				</Box>
			</Center>
		</Center>
