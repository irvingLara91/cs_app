		...
		<Center>
			<Box p="15" w="full" maxW="85%">
				<Center>
					...
					<Text fontSize="10" mt="3" style={{textAlign: "center"}}>We will contact you soon to fine-tune details.</Text>
...
You can check details of your order </Text>
						<TouchableHighlight onPress={() => navigate({name: screens.ORDER_DETAILS, params: { orderId: 1 }})}>
							<Text fontSize="11" underline>here</Text>
						</TouchableHighlight>
					</Flex>
					<Box w="full" mt="5" mb="5">
						<Button bgColor="dark.50" borderRadius="none" onPress={() => navigate(screens.HOME)} >Continue</Button>
					</Box>
				</Center>
			</Box>
		</Center>
